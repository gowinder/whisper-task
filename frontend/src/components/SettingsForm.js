    ...
    <Dialog open={isOpen} onClose={onClose}>
      ...
      <DialogContent>
        <form onSubmit={handleSubmit}>
          ...
          {settingsData.scheduler_interval && (
            <TextField
              fullWidth
              margin="normal"
          ...
          {settingsData.task && (
            <FormControl fullWidth margin="normal">
              ...
              <Select label="Task" name="task" value={settingsData.task} onChange={handleChange}>
